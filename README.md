...
A interface foi atualizada com o sistema **AvatarMAP**, um mascote visual que acompanha o progresso do usuário.

Principais recursos:

- evolução visual automática em 6 níveis, baseada no XP acumulado;
- linha do tempo com níveis concluídos, atual e bloqueados;
- tela de personalização com essências e acessórios desbloqueáveis;
- seleção de acessórios persistida no AsyncStorage;
- cards de progresso e conquistas integrados ao mascote;
- ícones do `@expo/vector-icons` no lugar dos emojis da interface;
- novo visual em azul, turquesa e tons suaves, mantendo as paletas de acessibilidade.

Arquivos principais adicionados:

```txt
newcare/
  assets/images/avatar-map/
    avatar-level-1.png ... avatar-level-6.png
  src/components/
    AvatarMapCard.tsx
  src/data/
    avatarMap.ts
